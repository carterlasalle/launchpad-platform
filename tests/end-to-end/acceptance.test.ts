...
function previewTransport(projectName: string, deployment: { id: string; state: string; url: string; logLines?: string[] }, commit = COMMIT_A, repository = ACCEPTANCE_REPOSITORY): RecordedSandboxTransport {
